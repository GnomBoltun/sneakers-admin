      ...
      onMounted(() => {
        if(dropRef.value !== null) {
          new Dropzone(dropRef.value, {
            ...
            url: 'http://localhost:3011/file/', // CHECK DROPZONE DEPENDENCY DOCS
            method: 'POST',
          ...
          if(dropRef.value.querySelector('.dz-default')) {
            dropRef.value.querySelector('.dz-default').innerHTML = `
              <div style="display: flex; justify-content: center;">
                <svg width="10em" height="10em" viewBox="0 0 16 12" fill="#2E9CB5" xmlns="http://www.w3.org/2000/svg" style="pointer-events: none;">
              ...
              <p style="text-align: center; margin: 0; font-weight: 500">ПЕРЕТАЩИТЕ ФАЙЛЫ СЮДА</p>
              <p style="text-align: center; margin-top: 0;"><small style="color: #999;">Ваши файлы будут добавленны автоматически</small></p>
              <button style="background-color: #2E9CB5; padding: 10px; border-radius: 10px; color: white; margin-top: 10px">ВЫБРАТЬ ФАЙЛЫ<button>
            `
          }
        }
      })
